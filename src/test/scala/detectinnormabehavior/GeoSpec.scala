...
abstract class GeoSpec extends FlatSpec with Matchers with
  ...
  val resourceFolder1 = Paths.get(System.getProperty("user.dir"),"src","test","resources")
  ...
  implicit val sparkSession:SparkSession = SparkSession.builder().config("spark.serializer",classOf[KryoSerializer].getName).
